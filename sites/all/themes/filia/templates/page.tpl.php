...
<div id="main" class="clearfix main" role="main">
    ...
    <div id="main-slider" class="row-fluid main-slider"> <?php print render($page['main_slider']); ?> </div>
    <?php endif; ?>
  <div class="container">
    <?php if ($breadcrumb): ?>
    ...
    <div id="main-menu" class="row-fluid main-menu"> <?php print render($page['main_menu']); ?> </div>
    <?php endif; ?>
